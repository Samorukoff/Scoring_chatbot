...
bag = BaggingClassifier(estimator=DecisionTreeClassifier(class_weight='balanced'), n_estimators=50, random_state=42)
...
# Получаем входы в мета-модель (то, что "видит" LogisticRegression)
X_meta = stacking.transform(X_test)
...
# Выгрузка модели
logging.info("Сохранение модели в файл 'model/stacking_model.pkl'...")
